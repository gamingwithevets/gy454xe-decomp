...
- Diagnostic mode present on fx-570/991ES PLUS `GY454X VerF`/`GY455X VerF`. This specific version of the diagnostic mode includes a [debug menu](https://gwe.42web.io/calcupedia/Calculator_self-test?i=1#Debug_menu) similar, but not the same as that of 2nd edition series. Currently, this ROM has not been dumped, nor is there an emulator ROM available.
