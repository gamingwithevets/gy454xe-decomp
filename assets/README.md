This directory contains scripts and files used in the decomp, either as a build requirement, or as helper scripts
used to assist in the decomp. These scripts may not have provided documentation, so you may need to look at the code
to find out how to use the script.
