...
extern char *const unk_0078a[];
extern const dim matrix_dims[];
extern char *const unk_007e6[];
extern const dim vector_dims[];
extern const char matvct_strings[4][4];
extern const dim unk_0080a[];
extern const dim unk_00812[];
extern char *const table_param_ptrs[];
extern const char table_eqn_linel_params[4][4];
extern const char table_eqn_liner_params[4][4];
...
extern const char s_table_a[];
extern const char s_table_1[];
...
extern const char menu_matrix_sel[];
extern const char menu_mata_dim_sel[];
extern const char menu_matb_dim_sel[];
extern const char menu_matc_dim_sel[];
...
extern const char menu_vector_sel[];
extern const char menu_vcta_dim_sel[];
extern const char menu_vctb_dim_sel[];
extern const char menu_vctc_dim_sel[];
...
extern void f_0336A(char viewport);
...
extern char is_sto_abc_keycode(char keycode);
extern char is_func_table(void);
...
extern char *f_043AC(char a, char b, char c);
extern void table_stat_get_cell_addr(char x, char y, char **out);
extern char table_stat_get_col_addr(char x, char **out);
extern char table_stat_get_num_cols(void);
extern void smart_num_cpy(char *dest, char *src);
